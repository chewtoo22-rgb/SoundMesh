...
enum class SpatialZone(
    ...
    LEFT_STAGE("Left Stage", "LEFT", "Stage Left & Front-Left placement", SpeakerChannel.LEFT_ONLY),
    CENTER_STAGE("Center Stage", "CENTER", "Vocal clarity, lead dialogue & focus", SpeakerChannel.CENTER, AudioProfile.VOCAL_BOOST),
    RIGHT_STAGE("Right Stage", "RIGHT", "Stage Right & Front-Right placement", SpeakerChannel.RIGHT_ONLY),
    REAR_SURROUND("Rear Surround", "SURROUND", "Ambient 3D surround sound", SpeakerChannel.SURROUND_LEFT, AudioProfile.WIDE_STAGE),
    SUB_BASS("Sub / Bass Zone", "SUB/BASS", "Dedicated low-end bass reinforcement", SpeakerChannel.SUBWOOFER, AudioProfile.BASS_BLAST),
    ALL_PARTY("Whole Room", "PARTY", "All-around stereo party room fill", SpeakerChannel.STEREO_ALL, AudioProfile.ALL_STEREO)
}
